...
const PIXEL_SIZE = 10;
class MagnifyingGlass extends r$1 {
    constructor() {
        super(...arguments);
...
class AnalysisView extends r$1 {
    constructor() {
        super();
        this.leftImage = null;
...
class RenderingScenario extends r$1 {
    constructor() {
        super(...arguments);
        this.name = '';
        this.goldens = [];
...
class ImageComparisonApp extends r$1 {
    constructor() {
        super(...arguments);
        this.src = '';
        this.config = null;
