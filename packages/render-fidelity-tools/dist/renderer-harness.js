...
let RendererConfiguration = class RendererConfiguration extends r$1 {
    constructor() {
        super(...arguments);
...
__decorate([
    n({ type: String, attribute: 'scenario-name' })
], RendererConfiguration.prototype, "scenarioName", void 0);
__decorate([
    n({ type: String, attribute: 'config-url' })
], RendererConfiguration.prototype, "configUrl", void 0);
__decorate([
    n({ type: Boolean, attribute: 'hide-ui' })
